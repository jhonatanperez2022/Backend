...
export const saveGameInCart = async (req, body) => {
...
export const deleteCart = async (req, body) => {
    const id = req.params.id
    const cart = await cartSchema.deleteMany({ _id: id })
    res.send({ status: 'success', cart })
}

export const deleteGameInCart = async (req, body) => {
    const idCart = req.params.cid
    const idGame = req.params.pid
...
export const updateCart = async (req, body) => {
    const id = req.params.id
    const cart = await cartSchema.updateOne({ _id: id }, req.body)
    res.send({ status: 'success', cart })
}

export const updateGameInCart = async (req, body) => {
    const idCart = req.params.cid
    const idGame = req.params.pid
